...
workspace_name = "MSIPrediction_workspace" # PLACEHOLDER
subscription_id = "a8277b15-c41c-484e-b983-309e2d02e714" # PLACEHOLDER
resource_group = "MSIPrediction_ML" # PLACEHOLDER
experiment_name = "Experiment5_OnlyAdults_Regression" # PLACEHOLDER
iteration = "45"  # PLACEHOLDER
run_id = "AutoML_86a05242-dec9-468f-a3b7-b33247e1784e_45"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'msipredictioncompute','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':360,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':360,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':5,'name':'Experiment5_OnlyAdults_Regression','path':'./sample_projects/Experiment5_OnlyAdults_Regression','primary_metric':'normalized_root_mean_squared_error','region':'eastus','resource_group':'MSIPrediction_ML','subscription_id':'a8277b15-c41c-484e-b983-309e2d02e714','task_type':'regression','validation_size':None,'test_size':0.1,'vm_type':'STANDARD_DS3_V2','workspace_name':'MSIPrediction_workspace','label_column_name':'icu_stay_duration','tuning_config':{'enable_tuning_run':True},'enable_batch_run':True,'dataset_id':'7a1ce48d-2cc1-46bd-970f-8ddb5a5fb2d5'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','ensemble_iterations':15,'is_timeseries':False,'name':'Experiment5_OnlyAdults_Regression','compute_target':'msipredictioncompute','subscription_id':'a8277b15-c41c-484e-b983-309e2d02e714','region':'eastus','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_86a05242-dec9-468f-a3b7-b33247e1784e_45\",\"experiment_name\":\"Experiment5_OnlyAdults_Regression\",\"workspace_name\":\"MSIPrediction_workspace\",\"subscription_id\":\"a8277b15-c41c-484e-b983-309e2d02e714\",\"resource_group_name\":\"MSIPrediction_ML\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"7a1ce48d-2cc1-46bd-970f-8ddb5a5fb2d5\"}}" # PLACEHOLDER
